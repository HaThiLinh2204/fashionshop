...
/**
 * Criteria class for the {@link com.gr2.fashionshop.domain.Category} entity. This class is used
 * in {@link com.gr2.fashionshop.controller.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, type, imageUrl, distinct);
    }
